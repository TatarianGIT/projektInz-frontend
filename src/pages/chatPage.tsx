...
const ChatPage = () => {
  ...
  return (
    <div className="lg:w-screen lg:h-screen bg-white dark:bg-[#242424]">
      <div className="lg:max-w-screen-2xl mx-auto w-full flex flex-col lg:h-[55rem]">
        <header className="flex justify-between items-center p-4 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="text-gray-500 hover:text-gray-700 transition ml-2  py-2"
              onClick={() => {
        ...
        <div className="grid lg:grid-cols-4 lg:px-4 pb-4 gap-4 h-full">
          ...
          <div className="lg:col-span-3 flex flex-col p-2 lg:p-4 pt-8 h-full relative overflow-hidden">
            <div className="absolute h-20 -inset-x-24 -top-4 bg-white dark:bg-[#242424] blur-lg hidden lg:block"></div>
            {room ? (
              <Chat
                socket={socket}
                room={room}
              ...
              <div className="py-16 text-black dark:text-darkTextPrimaryColor flex justify-center items-center">
